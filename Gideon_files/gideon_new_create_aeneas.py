...
def create_aeneas_csv(df=input_df,book_chapter_list=book_chapter_list,input_audio_dir=input_audio_dir):
    for each_chapter in book_chapter_list:
        ...
        config_string = u"task_adjust_boundary_percent_value=50|task_adjust_boundary_nonspeech_min=0.4|task_language=en|is_text_type=plain|os_task_file_format=aud"
        print(config_string)
