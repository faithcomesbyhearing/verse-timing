...
# print(field_names)
conn = pymysql.connect(host=TIM_HOST,user=TIM_USER,password="pS193DNhaGxoO5v",db=TIM_DB_NAME,port=TIM_PORT,charset='utf8mb4',cursorclass=pymysql.cursors.Cursor)
cursor=conn.cursor()
